...
In this report, we design and evaluate a short-term trading strategy for Chainlink's native token LINK, a top-25 cryptocurrency that serves as a decentralized oracle network within the DeFi ecosystem. Chainlink stands out as a compelling asset due to its high liquidity, large market cap, and fundamental utility, which make it less susceptible to manipulation and more likely to exhibit predictable price dynamics.
...
To quantify short-term trends in LINK’s price, we construct a \textbf{7-day momentum signal} defined as the logarithmic return over the past seven trading days:
