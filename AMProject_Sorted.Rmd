...
plot_2 <- ggplot(df_daily %>% drop_na(), aes(x = date, y = log_return)) +
  geom_point(color = "#990000", size = 1.5, alpha = 0.7) + 
  labs(
...
Figure 1 shows two plots side-by-side: 

- The **left panel** displays the daily closing price of CHAINLINK in USD since 2018, highlighting the asset’s strong bull run during the 2020–2021 crypto boom and its subsequent volatility.
- The **right panel** shows the corresponding daily log returns, capturing the day-to-day fluctuations in price.
...
#TODO: find the right location for the following code chunk: 
